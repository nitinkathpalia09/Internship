...
NTSTATUS DriverEntry(__in PDRIVER_OBJECT DriverObject, __in  PUNICODE_STRING RegistryPath)
{
	...
	UNICODE_STRING      DllPath32 = RTL_CONSTANT_STRING(L"\\dosdevices\\C:\\DriverTest\\DriverDll.dll");
	
#ifdef _AMD64_
	
		UNICODE_STRING	DllPath64= RTL_CONSTANT_STRING(L"\\dosdevices\\C:\\DriverTest\\hello-world-x64.dll");
